...
void GameFramework::createDescriptorSetLayout()
{
...
void GameFramework::createGraphicsPipeline()
{
...
void GameFramework::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
...
void GameFramework::createTextureImage()
{
...
void GameFramework::createTextureImageView()
{
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
}

void GameFramework::createTextureSampler()
{
...
VkImageView GameFramework::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels)
{
...
void GameFramework::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
void GameFramework::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void GameFramework::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void GameFramework::createVertexBuffer()
{
...
void GameFramework::createIndexBuffer()
{
...
void GameFramework::createUniformBuffers()
{
...
void GameFramework::createDescriptorPool()
{
...
void GameFramework::createDescriptorSets()
{
...
void GameFramework::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
...
VkCommandBuffer GameFramework::beginSingleTimeCommands()
{
...
void GameFramework::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void GameFramework::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
uint32_t GameFramework::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
void GameFramework::updateUniformBuffer(uint32_t currentImage)
{
...
VkShaderModule GameFramework::createShaderModule(const std::vector<char>& code)
{
...
std::vector<char> GameFramework::readFile(const std::string& filename)
{
